...
type ChatServiceClient interface {
	...
	SendMessage(ctx context.Context, in *ChatMessage, opts ...grpc.CallOption) (*ConnectionAck, error)
...
func (c *chatServiceClient) SendMessage(ctx context.Context, in *ChatMessage, opts ...grpc.CallOption) (*ConnectionAck, error) {
	out := new(ConnectionAck)
	err := c.cc.Invoke(ctx, "/messaging.ChatService/SendMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) ReceiveMessages(ctx context.Context, in *User, opts ...grpc.CallOption) (ChatService_ReceiveMessagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/messaging.ChatService/ReceiveMessages", opts...)
	if err != nil {
		return nil, err
	}
...
type ChatServiceServer interface {
	// Method to send a chat message
	SendMessage(context.Context, *ChatMessage) (*ConnectionAck, error)
	// Method to receive chat messages in real-time
...
func (UnimplementedChatServiceServer) SendMessage(context.Context, *ChatMessage) (*ConnectionAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendMessage not implemented")
}
func (UnimplementedChatServiceServer) ReceiveMessages(*User, ChatService_ReceiveMessagesServer) error {
...
func _ChatService_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/messaging.ChatService/SendMessage",
	}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "messaging.ChatService",
